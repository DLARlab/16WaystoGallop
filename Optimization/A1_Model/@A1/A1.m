classdef A1 < RobotLinks
    % A1 class to be used with FROST
    %
    %   Author: Zhenyu Gan
    %   Date:   10/20/2020
    %
    ...
    methods
        ...
        function obj = A1(urdf)
            ...
            [limits(1:6).lower] = deal(-10, -10, +0.0, -pi, deg2rad(-10), deg2rad(-3));
            [limits(1:6).upper] = deal(+10, +10, +0.5, +pi, deg2rad(+10), deg2rad(+3));
            ...
            % have to manully remove base and the collision only links from the urdf (TODO (ZG): modify this function)
            ...
            FR_foot_frame = obj.Joints(getJointIndices(obj, 'FR_calf_joint'));
            obj.ContactPoints.FRfoot = CoordinateFrame(...
                'Name','FRfoot',...
                'Reference',FR_foot_frame,...
                'Offset',[0 0 -0.2],...
                'R',R...
                );            
            
            % Bottom of toe
            FL_foot_frame = obj.Joints(getJointIndices(obj, 'FL_calf_joint'));
            obj.ContactPoints.FLfoot = CoordinateFrame(...
                'Name','FLfoot',...
            ...
            RR_foot_frame = obj.Joints(getJointIndices(obj, 'RR_calf_joint'));
            obj.ContactPoints.RRfoot = CoordinateFrame(...
                'Name','RRfoot',...
                'Reference',RR_foot_frame,...
                'Offset',[0 0 -0.2],...
                'R',R...
                );
            
            
            RL_foot_frame = obj.Joints(getJointIndices(obj, 'RL_calf_joint'));
            obj.ContactPoints.RLfoot = CoordinateFrame(...
                'Name','RLfoot',...
                'Reference',RL_foot_frame,...
                'Offset',[0 0 -0.2],...
                'R',R...
                );
            ...
            %% Define other frames
            torso_frame = obj.Joints(getJointIndices(obj, 'BaseRotX'));
