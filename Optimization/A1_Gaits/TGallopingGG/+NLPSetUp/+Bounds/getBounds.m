...
% bounds.stance_FLRR.params.pRRfoot.x0 = [-0.157538;-0.042628;0];

bounds.stance_FLRR.params.pRRfoot.lb = [-10;-10;0];
bounds.stance_FLRR.params.pRRfoot.ub = [+10;+10;0]; 
% bounds.stance_FLRR.params.pRLfoot.x0 = [-0.157538;0.047;0];
