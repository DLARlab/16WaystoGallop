...
%% FRRR stance phase
bounds.stance_FRRR = model_bounds;

% virtual constraints 
bounds.stance_FRRR.time.t0.lb = 0; 
bounds.stance_FRRR.time.t0.ub = 0;  
bounds.stance_FRRR.time.t0.x0 = 0;  

bounds.stance_FRRR.time.tf.lb = 0; 
bounds.stance_FRRR.time.tf.ub = 1;  
bounds.stance_FRRR.time.tf.x0 = 0.2;  

bounds.stance_FRRR.time.duration.lb = 0.03; 
bounds.stance_FRRR.time.duration.ub = 1;  
bounds.stance_FRRR.time.duration.x0 = 0.2;  

bounds.stance_FRRR.time.kp = 150;
bounds.stance_FRRR.time.kd = 20;

% forces
bounds.stance_FRRR.inputs.ConstraintWrench.fFRfoot.lb = -10000;
bounds.stance_FRRR.inputs.ConstraintWrench.fFRfoot.ub = 10000;
bounds.stance_FRRR.inputs.ConstraintWrench.fFRoot.x0 = 100;

bounds.stance_FRRR.inputs.ConstraintWrench.fRRfoot.lb = -10000;
bounds.stance_FRRR.inputs.ConstraintWrench.fRRfoot.ub = 10000;
bounds.stance_FRRR.inputs.ConstraintWrench.fRRfoot.x0 = 100;

% contacts
bounds.stance_FRRR.params.pFRfoot.lb = [-10;-10;0];
bounds.stance_FRRR.params.pFRfoot.ub = [+10;+10;0];

bounds.stance_FRRR.params.pRRfoot.lb = [-10;-10;0];
bounds.stance_FRRR.params.pRRfoot.ub = [+10;+10;0]; 

bounds.stance_FRRR.params.atime.lb = -100*ones(6*12,1); % 5th order polynomial * 12 joints
bounds.stance_FRRR.params.atime.ub =  100*ones(6*12,1);
bounds.stance_FRRR.params.atime.x0 =    zeros(6*12,1);

bounds.stance_FRRR.params.ptime.lb = [bounds.stance_FRRR.time.tf.lb, bounds.stance_FRRR.time.t0.lb];
bounds.stance_FRRR.params.ptime.ub = [bounds.stance_FRRR.time.tf.ub, bounds.stance_FRRR.time.t0.ub];
bounds.stance_FRRR.params.ptime.x0 = [bounds.stance_FRRR.time.tf.x0, bounds.stance_FRRR.time.t0.x0];

%% FLRL stance phase
bounds.stance_FLRL = model_bounds;

% virtual constraints 
bounds.stance_FLRL.time.t0.lb = 0; 
bounds.stance_FLRL.time.t0.ub = 0;  
bounds.stance_FLRL.time.t0.x0 = 0;  

bounds.stance_FLRL.time.tf.lb = 0; 
bounds.stance_FLRL.time.tf.ub = 1;  
bounds.stance_FLRL.time.tf.x0 = 0.2;  

bounds.stance_FLRL.time.duration.lb = 0.03; 
bounds.stance_FLRL.time.duration.ub = 1;  
bounds.stance_FLRL.time.duration.x0 = 0.2;  

bounds.stance_FLRL.time.kp = 150;
bounds.stance_FLRL.time.kd = 20;

% forces
bounds.stance_FLRL.inputs.ConstraintWrench.fFLfoot.lb = -10000;
bounds.stance_FLRL.inputs.ConstraintWrench.fFLfoot.ub = 10000;
bounds.stance_FLRL.inputs.ConstraintWrench.fFLoot.x0 = 100;

bounds.stance_FLRL.inputs.ConstraintWrench.fRLfoot.lb = -10000;
bounds.stance_FLRL.inputs.ConstraintWrench.fRLfoot.ub = 10000;
bounds.stance_FLRL.inputs.ConstraintWrench.fRLfoot.x0 = 100;

% contacts
bounds.stance_FLRL.params.pFLfoot.lb = [-10;-10;0];
bounds.stance_FLRL.params.pFLfoot.ub = [+10;+10;0];

bounds.stance_FLRL.params.pRLfoot.lb = [-10;-10;0];
bounds.stance_FLRL.params.pRLfoot.ub = [+10;+10;0]; 

bounds.stance_FLRL.params.atime.lb = -100*ones(6*12,1); % 5th order polynomial * 12 joints
bounds.stance_FLRL.params.atime.ub =  100*ones(6*12,1);
bounds.stance_FLRL.params.atime.x0 =    zeros(6*12,1);

bounds.stance_FLRL.params.ptime.lb = [bounds.stance_FLRL.time.tf.lb, bounds.stance_FLRL.time.t0.lb];
bounds.stance_FLRL.params.ptime.ub = [bounds.stance_FLRL.time.tf.ub, bounds.stance_FLRL.time.t0.ub];
bounds.stance_FLRL.params.ptime.x0 = [bounds.stance_FLRL.time.tf.x0, bounds.stance_FLRL.time.t0.x0];
