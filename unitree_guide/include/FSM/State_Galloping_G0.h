...
#ifndef GALLOPING_G0_H
#define GALLOPING_G0_H
...
class State_Galloping_G0 : public FSMState{
public:
    State_Galloping_G0(CtrlComponents *ctrlComp);
    ~State_Galloping_G0();
    void enter(); 
    void run();
    void exit();
