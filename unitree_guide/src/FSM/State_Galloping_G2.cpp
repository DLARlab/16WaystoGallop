...
#include <ros/ros.h>
#include <iostream>
#include "FSM/State_Galloping_G2.h"
...
State_Galloping_G2::State_Galloping_G2(CtrlComponents *ctrlComp)
             :FSMState(ctrlComp, FSMStateName::GALLOPING_G2, "Galloping_G2"), 
...
State_Galloping_G2::~State_Galloping_G2(){
    delete _gait;
}

void State_Galloping_G2::enter(){
...
FSMStateName State_Galloping_G2::checkChange(){
...
bool State_Galloping_G2::checkStepOrNot(){
...
// void State_Galloping_G2::setHighCmd(double vx, double vy, double wz){
//     _vbCmdBody(0) = vx;
//     _vbCmdBody(1) = vy;
//     _vbCmdBody(2) = 0; 
//     _dYawCmd = wz;
...
void State_Galloping_G2::getUserCmd(){
    /* Movement */
...
void State_Galloping_G2::calcCmd(){
    /* Movement */
 ...
 */
void State_Galloping_G2::calcTau(){
    // if((*_contact)(0) == 1 || (*_contact)(1) == 1){
 ...
 * 
 */
void State_Galloping_G2::calcQQd(){
...
Vec3 State_Galloping_G2::xProd(Vec3 vec1, Vec3 vec2){
    Vec3 vec3;
...
void State_Galloping_G2::plotData(std::vector<std::vector<double>>& desd_data, std::vector<std::vector<double>>& actual_data){
...
void State_Galloping_G2::plotSubPlot(std::vector<std::vector<double>>& desd_data, std::vector<std::vector<double>>& actual_data, int legNum){
...
void State_Galloping_G2::plotGRF(std::vector<std::vector<double>>& desd_data, std::vector<std::vector<double>>& actual_data){
...
void State_Galloping_G2::plotXZ(std::vector<std::vector<double>>& desd_data, std::vector<std::vector<double>>& actual_data){
